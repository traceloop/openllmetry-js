...
export const SpanAttributes = {
  ...
  LLM_SYSTEM: ATTR_GEN_AI_SYSTEM,
  LLM_REQUEST_MODEL: ATTR_GEN_AI_REQUEST_MODEL,
  LLM_REQUEST_MAX_TOKENS: ATTR_GEN_AI_REQUEST_MAX_TOKENS,
  LLM_REQUEST_TEMPERATURE: ATTR_GEN_AI_REQUEST_TEMPERATURE,
  LLM_REQUEST_TOP_P: ATTR_GEN_AI_REQUEST_TOP_P,
  LLM_PROMPTS: ATTR_GEN_AI_PROMPT,
  LLM_COMPLETIONS: ATTR_GEN_AI_COMPLETION,
  LLM_INPUT_MESSAGES: ATTR_GEN_AI_INPUT_MESSAGES,
  LLM_OUTPUT_MESSAGES: ATTR_GEN_AI_OUTPUT_MESSAGES,
  LLM_RESPONSE_MODEL: ATTR_GEN_AI_RESPONSE_MODEL,
  LLM_USAGE_PROMPT_TOKENS: ATTR_GEN_AI_USAGE_PROMPT_TOKENS,
  LLM_USAGE_COMPLETION_TOKENS: ATTR_GEN_AI_USAGE_COMPLETION_TOKENS,
  GEN_AI_OPERATION_NAME: ATTR_GEN_AI_OPERATION_NAME,
  GEN_AI_PROVIDER_NAME: ATTR_GEN_AI_PROVIDER_NAME,
  GEN_AI_TOOL_NAME: ATTR_GEN_AI_TOOL_NAME,
  GEN_AI_TOOL_CALL_ID: ATTR_GEN_AI_TOOL_CALL_ID,
  GEN_AI_TOOL_CALL_ARGUMENTS: ATTR_GEN_AI_TOOL_CALL_ARGUMENTS,
  GEN_AI_TOOL_CALL_RESULT: ATTR_GEN_AI_TOOL_CALL_RESULT,
  GEN_AI_RESPONSE_ID: ATTR_GEN_AI_RESPONSE_ID,
  GEN_AI_RESPONSE_FINISH_REASONS: ATTR_GEN_AI_RESPONSE_FINISH_REASONS,
  GEN_AI_CONVERSATION_ID: ATTR_GEN_AI_CONVERSATION_ID,
  GEN_AI_AGENT_NAME: ATTR_GEN_AI_AGENT_NAME,
